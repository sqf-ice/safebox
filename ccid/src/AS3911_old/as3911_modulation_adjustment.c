...
unsigned char  testdebug3;


unsigned char testLookUpTableX(void)
{
	unsigned char amplitudePhase = 0;
	u32 irqs = 0;

	//  as3911WriteRegister(AS3911_REG_RFO_AM_OFF_LEVEL, 0x80);
	//as3911WriteRegister(AS3911_REG_RFO_AM_OFF_LEVEL, 0x08);
	...
	testdebug3 = amplitudePhase;

	return 0;
}

unsigned char testLookUpTableY(void)
{
	...
	u32 irqs = 0;
	 ...
	 as3911WriteRegister(AS3911_REG_RFO_AM_OFF_LEVEL, 0x00);
	  as3911WriteRegister(AS3911_REG_AM_MOD_DEPTH_CONF,0x9E);
		...
		as3911ReadRegister(AS3911_REG_AM_MOD_DEPTH_RESULT, &amplitudePhase);
