...
void emvSecApp(unsigned char *emvResponseBuf,unsigned char * len)
{
//	s16 error = EMV_ERR_OK;
	size_t responseLength = 0;

	//emvDisplayCAPDU(emvSelectppseApdu, sizeof(emvSelectppseApdu));
//    SendString((unsigned char *)"Send App Cmd \r\n");
	
//	error = 
	emvTransceiveApdu(emvSelectppseApdu, sizeof(emvSelectppseApdu)
	, emvResponseBuf, EMV_RESPONSE_BUFFER_SIZE, &responseLength);
