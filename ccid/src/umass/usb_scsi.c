...
unsigned int udisk_lba_param[4];
...
/*  ReadFormatCapacity_Data[4] = (uint8_t)(Mass_Block_Count[lun] >> 24);
  ...
  ReadFormatCapacity_Data[0]=0x00;
  ReadFormatCapacity_Data[1]=0x00;
  ReadFormatCapacity_Data[2]=0x00;
  ReadFormatCapacity_Data[3]=0x08;

  ReadFormatCapacity_Data[4]=0x00;
  ReadFormatCapacity_Data[5]=0x01;
  ReadFormatCapacity_Data[6]=0xec;
  ReadFormatCapacity_Data[7]=0xff;


  ReadFormatCapacity_Data[8]=0x00;
  ReadFormatCapacity_Data[9]=0x00;
  ReadFormatCapacity_Data[10]=0x02;
  ReadFormatCapacity_Data[11]=0x00;
...
//  if (MAL_GetStatus(lun))
  ...
  */
    ...
    ReadFormatCapacity_Data[0]=0x00;
	ReadFormatCapacity_Data[1]=0x20;
	ReadFormatCapacity_Data[2]=0x00;
	ReadFormatCapacity_Data[3]=0x00;
	ReadFormatCapacity_Data[4]=0x00;
	ReadFormatCapacity_Data[5]=0x00;
	ReadFormatCapacity_Data[6]=0x02;
	ReadFormatCapacity_Data[7]=0x00;
...
//	unsigned char i;
  ...
  else if (Bot_State == BOT_DATA_IN)
  {
	...
	if((udisk_lba_param[INDEX_UDISK_LBA_XFER_COUNT])!=0)
    {
        ...
        //{
        //    APL_ExFlash_ReadData(udisk_lba_param[INDEX_UDISK_LBA_START], &g_ComBuf[USBFIFOOFFSET], SIZE_OF_SPIFLASH_PAGE);
        //}
        //else
        //{
           // APL_memset(Bulk_Data_Buff, 0, SIZE_OF_SPIFLASH_PAGE); 
       ...
       // }
        ...
        //MSC_SendData(&g_ComBuf[USBFIFOOFFSET], SIZE_OF_SPIFLASH_PAGE);
		
		  
        USB_SIL_Write(EP1_IN, (uint8_t *)Bulk_Data_Buff, BULK_MAX_PACKET_SIZE);
		
        udisk_lba_param[INDEX_UDISK_LBA_START] += BULK_MAX_PACKET_SIZE;
